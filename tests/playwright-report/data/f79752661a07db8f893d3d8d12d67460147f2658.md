...
- Name: app.spec.ts >> Регистрация >> ошибка при повторной регистрации с тем же email
- Location: e2e\app.spec.ts:93:7
...
Locator: getByText(/уже существует/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/уже существует/i)
...
- main:
  ...
  - textbox "Email":
    ...
    - text: register_1782748076966@test.com
  - text: Пароль
  - textbox "Пароль":
    - /placeholder: Минимум 6 символов
    - text: password123
  - text: Повторите пароль
  - textbox "Повторите пароль Пароли не совпадают":
