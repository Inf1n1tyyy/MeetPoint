...
- Name: app.spec.ts >> Регистрация >> успешная регистрация перенаправляет на /meetings
- Location: e2e\app.spec.ts:81:7
...
- main:
  ...
  - textbox "Email":
    ...
    - text: register_1782748061227@test.com
  - text: Пароль
  - textbox "Пароль":
